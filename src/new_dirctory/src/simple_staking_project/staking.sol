...
contract Staking {
    ...
    function deposit(uint256 amount) external payable {
        stakingPool.approve(msg.sender, amount);
        stakingPool.transferFrom(address(this), msg.sender, amount);
    ...
    //calculateDays- calculate the amount of deposits the user deposited before more than 7 days
